...
- Windows-x64: Download **[0.0.1-alpha.15 software (GitHub)](https://github.com/hai-vr/XYVR/releases/download/0.0.1-alpha.15/XYVR-0.0.1-alpha.15-windows-x64-executable.zip)**
...
The software under development can be downloaded at this location:
- Linux, x64: Download [0.0.1-alpha.15 software (GitHub)](https://github.com/hai-vr/XYVR/releases/download/0.0.1-alpha.15/xyvr-0.0.1-alpha.15-linux-x64-executable.tar.gz)
