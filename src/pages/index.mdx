...
<div class={clsx(styles.haiBanner2)}>
    <header className={clsx('hero hero--primary', styles.heroBanner, styles.heroBannerMini)}>
        <div className="container">
            <h1 className="hero__title">Haï~</h1>
            <p className="hero__subtitle">Tools and apps for social VR users</p>
            <div className={styles.buttons}>
                <Link
                    className="button button--secondary button--lg"
                    to="vcc://vpm/addRepo?url=https://hai-vr.github.io/vpm-listing/index.json">
                    <span>Add ALCOM listing</span>
                </Link>
                <Link
                    className="button button--secondary button--lg"
                    to="/updates">
...
<div className={clsx(patreonStyles.homepage)}><PatreonPlus />
<Patronelt k="-1">⭐ {PatreonMore.plusactive} and **{PatreonMore.regactive}** more **[Patreon Supporters ...](/docs/other/supporters)**</Patronelt>
