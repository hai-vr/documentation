...
修复：
- 修复了“仅显示非零值”按钮在 Unity 2022 中不可见的问题。
...
功能：
- 按住 ALT 键现在可以帮助您更准确地比较差异：
  - 默认情况下，按住 ALT 键显示未应用混合形状的原图。
  - 或者，使用下拉选项，按住 ALT 键可以以颜色高亮显示差异。
  - 变亮的区域使用黄色显示，变暗的区域使用红色显示。
- 添加了一个新过滤器，点击后仅显示值不为零的混合形状（blendshape）。
- 复选框状态现在会在编辑器会话之间保存。
- 添加本地化。
