...
- 필요한 경우, [다음 섹션의 안내에 따라 창 언어를 변경하세요](#창-언어-변경하기).
...
- 파란색 오브젝트는 프로젝트에 파일로 존재하는 프리팹 에셋인 *프리팹 소스* 또는 *프리팹 모델* 입니다.
- 초록색 오브젝트는 씬 오브젝트인 *프리팹 인스턴스* 입니다. 씬 내부 또는 다른 프리팹 내부에 존재할 수 있습니다.

*프리팹 인스턴스* 는 종종 의존하는 *프리팹 소스* 와 이름이 같아서 혼동될 수 있습니다. 그래서 색상으로 구분됩니다.
:::
...
- **선택**: 해당 타입의 에셋을 선택하여 내보내기에 포함합니다.
- **선택 해제**: 해당 타입의 에셋 선택을 해제하여 내보내기에서 제외합니다.
- **선택 해제 및 숨기기**: 해당 타입의 에셋 선택을 해제하고 내보내기 창에서 제거합니다.
    - *참고: 선택 해제 및 숨기기를 눌러도 해당 에셋들이 참조하는 에셋들의 선택이 해제되지는 않으므로, Transfer Assistant 창의 솎아내기 옵션과는 다릅니다.*
