...
- **Sélectionner** : Sélectionne les assets de ce type, ce qui les inclura dans l'exportation.
- **Désélectionner** : Désélectionne les assets de ce type, ce qui les exclura de l'exportation.
- **Désélectionner et masquer** : Désélectionne les assets de ce type et les supprime de la fenêtre d'exportation.
    - *Note : Appuyer sur Désélectionner et masquer ne désélectionnera **pas** les assets qui sont référencés par ces assets, c'est donc différent de l'option Élagage de la fenêtre Transfer Assistant.*
