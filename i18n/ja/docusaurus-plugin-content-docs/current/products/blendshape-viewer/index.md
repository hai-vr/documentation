...
*Blendshape Viewer* ウィンドウ内にカーソルを置いた状態で ALT キーを押すと、ブレンドシェイプが適用されていないオリジナルの画像を表示できます。

ALT キーの機能は、右上のドロップダウンで変更できます：

- ALT キーを押している間にオリジナルの画像を表示するには、*ALTキーでオリジナルを表示* を選択します。
...
*検索* フィールドの右側にある *非ゼロのみ表示* ボタンは、値が 0 以外のブレンドシェイプのみを表示するフィルタです。
