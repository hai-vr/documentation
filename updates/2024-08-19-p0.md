...
layer.NewState("UsingDrivers").Driving(driver => driver
    ...
    .Randomizes(layer.FloatParameter("Randomize"), 0f, 100f)
    .Randomizes(layer.BoolParameter("RandomizeBool"), 0.25f) // 25% chance of being true.
    .Remaps(layer.FloatParameter("RemapsSource"), 0f, 2f, layer.FloatParameter("RemapsDestination"), 2f, 4f)
).Driving(driver => driver // This creates a second VRCAvatarParameterDriver in the same behaviour.
